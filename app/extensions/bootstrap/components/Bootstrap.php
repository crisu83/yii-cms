...
class Bootstrap extends CApplicationComponent
{
    ...
    /**
     * @var string default collapse CSS selector.
     * @since 1.1.0
     */
    public $collapseSelector = '.collapse';
    /**
     * @var string default dropdown CSS selector.
     * @since 1.1.0
     */
    public $dropdownSelector = '.dropdown-toggle[data-dropdown="dropdown"]';
	/**
	...
	{
		$this->registerPlugin(self::PLUGIN_COLLAPSE, $selector, $options, $this->collapseSelector);
	}
	...
	{
		$this->registerPlugin(self::PLUGIN_DROPDOWN, $selector, $options, $this->dropdownSelector);
	}
